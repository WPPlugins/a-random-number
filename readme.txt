...
Donate link: http://www.macardam.com/donate/
...
For full documentation, see the plugin's page: http://www.macardam.com/a-random-number/
...
How dare you. It outputs a random number, so if you need a random number, there is nothing better.  This is also useful to check if a page is being cached or if your server is properly loading since the number will change on every page load.  See, that's practical.
